...
export const SystemErrorsKeysRotateOSService = createDelegatingOSServiceClass(
	TOKENS.SYSTEM_ERRORS_KEYS_ROTATE,
	["system:write"],
	createSystemErrorsKeysRotateService,
);
export const SystemErrorsKeysListOSService = createDelegatingOSServiceClass(
	TOKENS.SYSTEM_ERRORS_KEYS_LIST,
	["system:read"],
	createSystemErrorsKeysListService,
);
export const SystemErrorsKeysActivateOSService = createDelegatingOSServiceClass(
	TOKENS.SYSTEM_ERRORS_KEYS_ACTIVATE,
	["system:write"],
	createSystemErrorsKeysActivateService,
);
...
export const SYSTEM_OPERATIONS_SERVICE_DEFINITIONS = [
	...
	defineInjectableOSService(TOKENS.SYSTEM_ERRORS_KEYS_ROTATE, SystemErrorsKeysRotateOSService, [] as const),
	defineInjectableOSService(TOKENS.SYSTEM_ERRORS_KEYS_LIST, SystemErrorsKeysListOSService, [] as const),
	defineInjectableOSService(TOKENS.SYSTEM_ERRORS_KEYS_ACTIVATE, SystemErrorsKeysActivateOSService, [] as const),
] as const;
