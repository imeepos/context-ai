...
- 通知能力：`notification.send / notification.ack / notification.list / notification.mute / notification.mute.list / notification.unmute / notification.stats`（支持 dedupe window + mute window + since/until + rate limit）
