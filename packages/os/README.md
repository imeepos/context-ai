...
- 应用管理：`app.install / app.install.v1 / app.start / app.page.render / render / app.upgrade / app.list / app.state.set / app.disable / app.enable / app.uninstall`
