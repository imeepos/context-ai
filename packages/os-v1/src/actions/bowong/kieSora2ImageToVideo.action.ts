...
export const KieSora2ImageToVideoRequestSchema = Type.Object({
...
export type KieSora2ImageToVideoRequest = Static<typeof KieSora2ImageToVideoRequestSchema>;

export const KieSora2ImageToVideoResponseSchema = Type.Object({
...
export type KieSora2ImageToVideoResponse = Static<typeof KieSora2ImageToVideoResponseSchema>;

export const KIE_SORA2_IMAGE_TO_VIDEO_TOKEN: Token<typeof KieSora2ImageToVideoRequestSchema, typeof KieSora2ImageToVideoResponseSchema> = "bowong.model.kie.sora.2.image.to.video.run";

export const kieSora2ImageToVideoAction: Action<typeof KieSora2ImageToVideoRequestSchema, typeof KieSora2ImageToVideoResponseSchema> = {
	type: KIE_SORA2_IMAGE_TO_VIDEO_TOKEN,
	description: "Run Bowong model kie/sora-2-image-to-video",
	request: KieSora2ImageToVideoRequestSchema,
	response: KieSora2ImageToVideoResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: KieSora2ImageToVideoRequest, injector: Injector): Promise<KieSora2ImageToVideoResponse> => {
		...
		const response = await client.videos.create({
			model: "kie/sora-2-image-to-video",
			...(params as any),
		} as any);

		return {
			object: "video",
			model: (response as any).model ?? "kie/sora-2-image-to-video",
