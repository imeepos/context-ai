...
export const VolcengineDoubaoSeedream50260128RequestSchema = Type.Object({
...
export type VolcengineDoubaoSeedream50260128Request = Static<typeof VolcengineDoubaoSeedream50260128RequestSchema>;

export const VolcengineDoubaoSeedream50260128ResponseSchema = Type.Object({
...
export type VolcengineDoubaoSeedream50260128Response = Static<typeof VolcengineDoubaoSeedream50260128ResponseSchema>;

export const VOLCENGINE_DOUBAO_SEEDREAM50260128_TOKEN: Token<typeof VolcengineDoubaoSeedream50260128RequestSchema, typeof VolcengineDoubaoSeedream50260128ResponseSchema> = "bowong.model.volcengine.doubao.seedream.5.0.260128.run";

export const volcengineDoubaoSeedream50260128Action: Action<typeof VolcengineDoubaoSeedream50260128RequestSchema, typeof VolcengineDoubaoSeedream50260128ResponseSchema> = {
	type: VOLCENGINE_DOUBAO_SEEDREAM50260128_TOKEN,
	description: "Run Bowong model volcengine/doubao-seedream-5-0-260128",
	request: VolcengineDoubaoSeedream50260128RequestSchema,
	response: VolcengineDoubaoSeedream50260128ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: VolcengineDoubaoSeedream50260128Request, injector: Injector): Promise<VolcengineDoubaoSeedream50260128Response> => {
