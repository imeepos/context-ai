...
export const VolcengineDoubaoSeed20Pro260215RequestSchema = Type.Object({
  ...
  "search": Type.Optional(Type.Object({}, { additionalProperties: true }))
}, { "additionalProperties": false }))
}, { "additionalProperties": false });

export type VolcengineDoubaoSeed20Pro260215Request = Static<typeof VolcengineDoubaoSeed20Pro260215RequestSchema>;

export const VolcengineDoubaoSeed20Pro260215ResponseSchema = Type.Object({
...
export type VolcengineDoubaoSeed20Pro260215Response = Static<typeof VolcengineDoubaoSeed20Pro260215ResponseSchema>;

export const VOLCENGINE_DOUBAO_SEED20_PRO260215_TOKEN: Token<typeof VolcengineDoubaoSeed20Pro260215RequestSchema, typeof VolcengineDoubaoSeed20Pro260215ResponseSchema> = "bowong.model.volcengine.doubao.seed.2.0.pro.260215.run";

export const volcengineDoubaoSeed20Pro260215Action: Action<typeof VolcengineDoubaoSeed20Pro260215RequestSchema, typeof VolcengineDoubaoSeed20Pro260215ResponseSchema> = {
	type: VOLCENGINE_DOUBAO_SEED20_PRO260215_TOKEN,
	description: "Run Bowong model volcengine/doubao-seed-2-0-pro-260215",
	request: VolcengineDoubaoSeed20Pro260215RequestSchema,
	response: VolcengineDoubaoSeed20Pro260215ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: VolcengineDoubaoSeed20Pro260215Request, injector: Injector): Promise<VolcengineDoubaoSeed20Pro260215Response> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "volcengine/doubao-seed-2-0-pro-260215",
