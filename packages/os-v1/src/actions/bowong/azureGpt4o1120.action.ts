...
export const AzureGpt4o1120RequestSchema = Type.Object({
...
export type AzureGpt4o1120Request = Static<typeof AzureGpt4o1120RequestSchema>;

export const AzureGpt4o1120ResponseSchema = Type.Object({
...
export type AzureGpt4o1120Response = Static<typeof AzureGpt4o1120ResponseSchema>;

export const AZURE_GPT4O1120_TOKEN: Token<typeof AzureGpt4o1120RequestSchema, typeof AzureGpt4o1120ResponseSchema> = "bowong.model.azure.gpt.4o.1120.run";

export const azureGpt4o1120Action: Action<typeof AzureGpt4o1120RequestSchema, typeof AzureGpt4o1120ResponseSchema> = {
	type: AZURE_GPT4O1120_TOKEN,
	description: "Run Bowong model azure/gpt-4o-1120",
	request: AzureGpt4o1120RequestSchema,
	response: AzureGpt4o1120ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: AzureGpt4o1120Request, injector: Injector): Promise<AzureGpt4o1120Response> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "azure/gpt-4o-1120",
