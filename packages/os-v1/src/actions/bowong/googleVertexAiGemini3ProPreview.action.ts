...
export const GoogleVertexAiGemini3ProPreviewRequestSchema = Type.Object({
...
export type GoogleVertexAiGemini3ProPreviewRequest = Static<typeof GoogleVertexAiGemini3ProPreviewRequestSchema>;

export const GoogleVertexAiGemini3ProPreviewResponseSchema = Type.Object({
...
export type GoogleVertexAiGemini3ProPreviewResponse = Static<typeof GoogleVertexAiGemini3ProPreviewResponseSchema>;

export const GOOGLE_VERTEX_AI_GEMINI3_PRO_PREVIEW_TOKEN: Token<typeof GoogleVertexAiGemini3ProPreviewRequestSchema, typeof GoogleVertexAiGemini3ProPreviewResponseSchema> = "bowong.model.google.vertex.ai.gemini.3.pro.preview.run";

export const googleVertexAiGemini3ProPreviewAction: Action<typeof GoogleVertexAiGemini3ProPreviewRequestSchema, typeof GoogleVertexAiGemini3ProPreviewResponseSchema> = {
	type: GOOGLE_VERTEX_AI_GEMINI3_PRO_PREVIEW_TOKEN,
	description: "Run Bowong model google-vertex-ai/gemini-3-pro-preview",
	request: GoogleVertexAiGemini3ProPreviewRequestSchema,
	response: GoogleVertexAiGemini3ProPreviewResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: GoogleVertexAiGemini3ProPreviewRequest, injector: Injector): Promise<GoogleVertexAiGemini3ProPreviewResponse> => {
		...
		const response = await client.responses.create({
			model: "google-vertex-ai/gemini-3-pro-preview",
			...(params as any),
			stream: false,
		} as any);
		...
		return {
			object: "response",
			model: (response as any).model ?? "google-vertex-ai/gemini-3-pro-preview",
