...
export const VolcengineDoubaoSeed20CodePreview260215RequestSchema = Type.Object({
...
export type VolcengineDoubaoSeed20CodePreview260215Request = Static<typeof VolcengineDoubaoSeed20CodePreview260215RequestSchema>;

export const VolcengineDoubaoSeed20CodePreview260215ResponseSchema = Type.Object({
...
export type VolcengineDoubaoSeed20CodePreview260215Response = Static<typeof VolcengineDoubaoSeed20CodePreview260215ResponseSchema>;

export const VOLCENGINE_DOUBAO_SEED20_CODE_PREVIEW260215_TOKEN: Token<typeof VolcengineDoubaoSeed20CodePreview260215RequestSchema, typeof VolcengineDoubaoSeed20CodePreview260215ResponseSchema> = "bowong.model.volcengine.doubao.seed.2.0.code.preview.260215.run";

export const volcengineDoubaoSeed20CodePreview260215Action: Action<typeof VolcengineDoubaoSeed20CodePreview260215RequestSchema, typeof VolcengineDoubaoSeed20CodePreview260215ResponseSchema> = {
	type: VOLCENGINE_DOUBAO_SEED20_CODE_PREVIEW260215_TOKEN,
	description: "Run Bowong model volcengine/doubao-seed-2-0-code-preview-260215",
	request: VolcengineDoubaoSeed20CodePreview260215RequestSchema,
	response: VolcengineDoubaoSeed20CodePreview260215ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: VolcengineDoubaoSeed20CodePreview260215Request, injector: Injector): Promise<VolcengineDoubaoSeed20CodePreview260215Response> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "volcengine/doubao-seed-2-0-code-preview-260215",
