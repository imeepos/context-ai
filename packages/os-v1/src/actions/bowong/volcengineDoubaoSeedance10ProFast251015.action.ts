...
export const VolcengineDoubaoSeedance10ProFast251015RequestSchema = Type.Object({
...
export type VolcengineDoubaoSeedance10ProFast251015Request = Static<typeof VolcengineDoubaoSeedance10ProFast251015RequestSchema>;

export const VolcengineDoubaoSeedance10ProFast251015ResponseSchema = Type.Object({
...
export type VolcengineDoubaoSeedance10ProFast251015Response = Static<typeof VolcengineDoubaoSeedance10ProFast251015ResponseSchema>;

export const VOLCENGINE_DOUBAO_SEEDANCE10_PRO_FAST251015_TOKEN: Token<typeof VolcengineDoubaoSeedance10ProFast251015RequestSchema, typeof VolcengineDoubaoSeedance10ProFast251015ResponseSchema> = "bowong.model.volcengine.doubao.seedance.1.0.pro.fast.251015.run";

export const volcengineDoubaoSeedance10ProFast251015Action: Action<typeof VolcengineDoubaoSeedance10ProFast251015RequestSchema, typeof VolcengineDoubaoSeedance10ProFast251015ResponseSchema> = {
	type: VOLCENGINE_DOUBAO_SEEDANCE10_PRO_FAST251015_TOKEN,
	description: "Run Bowong model volcengine/doubao-seedance-1-0-pro-fast-251015",
	request: VolcengineDoubaoSeedance10ProFast251015RequestSchema,
	response: VolcengineDoubaoSeedance10ProFast251015ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: VolcengineDoubaoSeedance10ProFast251015Request, injector: Injector): Promise<VolcengineDoubaoSeedance10ProFast251015Response> => {
		...
		return {
			object: "video",
			model: (response as any).model ?? "volcengine/doubao-seedance-1-0-pro-fast-251015",
