...
export const GoogleVertexAiVeo31Generate001RequestSchema = Type.Object({
...
export type GoogleVertexAiVeo31Generate001Request = Static<typeof GoogleVertexAiVeo31Generate001RequestSchema>;

export const GoogleVertexAiVeo31Generate001ResponseSchema = Type.Object({
...
export type GoogleVertexAiVeo31Generate001Response = Static<typeof GoogleVertexAiVeo31Generate001ResponseSchema>;

export const GOOGLE_VERTEX_AI_VEO31_GENERATE001_TOKEN: Token<typeof GoogleVertexAiVeo31Generate001RequestSchema, typeof GoogleVertexAiVeo31Generate001ResponseSchema> = "bowong.model.google.vertex.ai.veo.3.1.generate.001.run";

export const googleVertexAiVeo31Generate001Action: Action<typeof GoogleVertexAiVeo31Generate001RequestSchema, typeof GoogleVertexAiVeo31Generate001ResponseSchema> = {
	type: GOOGLE_VERTEX_AI_VEO31_GENERATE001_TOKEN,
	description: "Run Bowong model google-vertex-ai/veo-3.1-generate-001",
	request: GoogleVertexAiVeo31Generate001RequestSchema,
	response: GoogleVertexAiVeo31Generate001ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: GoogleVertexAiVeo31Generate001Request, injector: Injector): Promise<GoogleVertexAiVeo31Generate001Response> => {
		...
		const response = await client.videos.create({
			model: "google-vertex-ai/veo-3.1-generate-001",
			...(params as any),
		} as any);

		return {
			object: "video",
			model: (response as any).model ?? "google-vertex-ai/veo-3.1-generate-001",
