...
export const KieHailuo23ImageToVideoStandardRequestSchema = Type.Object({
...
export type KieHailuo23ImageToVideoStandardRequest = Static<typeof KieHailuo23ImageToVideoStandardRequestSchema>;

export const KieHailuo23ImageToVideoStandardResponseSchema = Type.Object({
...
export type KieHailuo23ImageToVideoStandardResponse = Static<typeof KieHailuo23ImageToVideoStandardResponseSchema>;

export const KIE_HAILUO23_IMAGE_TO_VIDEO_STANDARD_TOKEN: Token<typeof KieHailuo23ImageToVideoStandardRequestSchema, typeof KieHailuo23ImageToVideoStandardResponseSchema> = "bowong.model.kie.hailuo.2.3.image.to.video.standard.run";

export const kieHailuo23ImageToVideoStandardAction: Action<typeof KieHailuo23ImageToVideoStandardRequestSchema, typeof KieHailuo23ImageToVideoStandardResponseSchema> = {
	type: KIE_HAILUO23_IMAGE_TO_VIDEO_STANDARD_TOKEN,
	description: "Run Bowong model kie/hailuo/2-3-image-to-video-standard",
	request: KieHailuo23ImageToVideoStandardRequestSchema,
	response: KieHailuo23ImageToVideoStandardResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: KieHailuo23ImageToVideoStandardRequest, injector: Injector): Promise<KieHailuo23ImageToVideoStandardResponse> => {
		...
		const response = await client.videos.create({
			model: "kie/hailuo/2-3-image-to-video-standard",
			...(params as any),
		} as any);

		return {
			object: "video",
			model: (response as any).model ?? "kie/hailuo/2-3-image-to-video-standard",
