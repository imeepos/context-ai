...
export const AzureGpt5MiniRequestSchema = Type.Object({
...
export type AzureGpt5MiniRequest = Static<typeof AzureGpt5MiniRequestSchema>;

export const AzureGpt5MiniResponseSchema = Type.Object({
...
export type AzureGpt5MiniResponse = Static<typeof AzureGpt5MiniResponseSchema>;

export const AZURE_GPT5_MINI_TOKEN: Token<typeof AzureGpt5MiniRequestSchema, typeof AzureGpt5MiniResponseSchema> = "bowong.model.azure.gpt.5.mini.run";

export const azureGpt5MiniAction: Action<typeof AzureGpt5MiniRequestSchema, typeof AzureGpt5MiniResponseSchema> = {
	type: AZURE_GPT5_MINI_TOKEN,
	description: "Run Bowong model azure/gpt-5-mini",
	request: AzureGpt5MiniRequestSchema,
	response: AzureGpt5MiniResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: AzureGpt5MiniRequest, injector: Injector): Promise<AzureGpt5MiniResponse> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "azure/gpt-5-mini",
