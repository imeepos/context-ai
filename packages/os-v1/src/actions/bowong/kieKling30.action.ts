...
export const KieKling30RequestSchema = Type.Object({
...
export type KieKling30Request = Static<typeof KieKling30RequestSchema>;

export const KieKling30ResponseSchema = Type.Object({
...
export type KieKling30Response = Static<typeof KieKling30ResponseSchema>;

export const KIE_KLING30_TOKEN: Token<typeof KieKling30RequestSchema, typeof KieKling30ResponseSchema> = "bowong.model.kie.kling.3.0.run";

export const kieKling30Action: Action<typeof KieKling30RequestSchema, typeof KieKling30ResponseSchema> = {
	type: KIE_KLING30_TOKEN,
	description: "Run Bowong model kie/kling-3.0",
	request: KieKling30RequestSchema,
	response: KieKling30ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: KieKling30Request, injector: Injector): Promise<KieKling30Response> => {
		...
		return {
			object: "video",
			model: (response as any).model ?? "kie/kling-3.0",
