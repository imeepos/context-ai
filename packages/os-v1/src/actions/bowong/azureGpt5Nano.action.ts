...
export const AzureGpt5NanoRequestSchema = Type.Object({
...
export type AzureGpt5NanoRequest = Static<typeof AzureGpt5NanoRequestSchema>;

export const AzureGpt5NanoResponseSchema = Type.Object({
...
export type AzureGpt5NanoResponse = Static<typeof AzureGpt5NanoResponseSchema>;

export const AZURE_GPT5_NANO_TOKEN: Token<typeof AzureGpt5NanoRequestSchema, typeof AzureGpt5NanoResponseSchema> = "bowong.model.azure.gpt.5.nano.run";

export const azureGpt5NanoAction: Action<typeof AzureGpt5NanoRequestSchema, typeof AzureGpt5NanoResponseSchema> = {
	type: AZURE_GPT5_NANO_TOKEN,
	description: "Run Bowong model azure/gpt-5-nano",
	request: AzureGpt5NanoRequestSchema,
	response: AzureGpt5NanoResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: AzureGpt5NanoRequest, injector: Injector): Promise<AzureGpt5NanoResponse> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "azure/gpt-5-nano",
