...
export const AzureGpt41RequestSchema = Type.Object({
...
export type AzureGpt41Request = Static<typeof AzureGpt41RequestSchema>;

export const AzureGpt41ResponseSchema = Type.Object({
...
export type AzureGpt41Response = Static<typeof AzureGpt41ResponseSchema>;

export const AZURE_GPT41_TOKEN: Token<typeof AzureGpt41RequestSchema, typeof AzureGpt41ResponseSchema> = "bowong.model.azure.gpt.4.1.run";

export const azureGpt41Action: Action<typeof AzureGpt41RequestSchema, typeof AzureGpt41ResponseSchema> = {
	type: AZURE_GPT41_TOKEN,
	description: "Run Bowong model azure/gpt-4.1",
	request: AzureGpt41RequestSchema,
	response: AzureGpt41ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: AzureGpt41Request, injector: Injector): Promise<AzureGpt41Response> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "azure/gpt-4.1",
