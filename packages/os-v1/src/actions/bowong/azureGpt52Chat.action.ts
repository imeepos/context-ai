...
export const AzureGpt52ChatRequestSchema = Type.Object({
...
export type AzureGpt52ChatRequest = Static<typeof AzureGpt52ChatRequestSchema>;

export const AzureGpt52ChatResponseSchema = Type.Object({
...
export type AzureGpt52ChatResponse = Static<typeof AzureGpt52ChatResponseSchema>;

export const AZURE_GPT52_CHAT_TOKEN: Token<typeof AzureGpt52ChatRequestSchema, typeof AzureGpt52ChatResponseSchema> = "bowong.model.azure.gpt.5.2.chat.run";

export const azureGpt52ChatAction: Action<typeof AzureGpt52ChatRequestSchema, typeof AzureGpt52ChatResponseSchema> = {
	type: AZURE_GPT52_CHAT_TOKEN,
	description: "Run Bowong model azure/gpt-5.2-chat",
	request: AzureGpt52ChatRequestSchema,
	response: AzureGpt52ChatResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: AzureGpt52ChatRequest, injector: Injector): Promise<AzureGpt52ChatResponse> => {
		...
		return {
			object: "response",
			model: (response as any).model ?? "azure/gpt-5.2-chat",
