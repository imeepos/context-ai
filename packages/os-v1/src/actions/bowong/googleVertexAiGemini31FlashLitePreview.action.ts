...
export const GoogleVertexAiGemini31FlashLitePreviewRequestSchema = Type.Object({
...
export type GoogleVertexAiGemini31FlashLitePreviewRequest = Static<typeof GoogleVertexAiGemini31FlashLitePreviewRequestSchema>;

export const GoogleVertexAiGemini31FlashLitePreviewResponseSchema = Type.Object({
...
export type GoogleVertexAiGemini31FlashLitePreviewResponse = Static<typeof GoogleVertexAiGemini31FlashLitePreviewResponseSchema>;

export const GOOGLE_VERTEX_AI_GEMINI31_FLASH_LITE_PREVIEW_TOKEN: Token<typeof GoogleVertexAiGemini31FlashLitePreviewRequestSchema, typeof GoogleVertexAiGemini31FlashLitePreviewResponseSchema> = "bowong.model.google.vertex.ai.gemini.3.1.flash.lite.preview.run";

export const googleVertexAiGemini31FlashLitePreviewAction: Action<typeof GoogleVertexAiGemini31FlashLitePreviewRequestSchema, typeof GoogleVertexAiGemini31FlashLitePreviewResponseSchema> = {
	type: GOOGLE_VERTEX_AI_GEMINI31_FLASH_LITE_PREVIEW_TOKEN,
	description: "Run Bowong model google-vertex-ai/gemini-3.1-flash-lite-preview",
	request: GoogleVertexAiGemini31FlashLitePreviewRequestSchema,
	response: GoogleVertexAiGemini31FlashLitePreviewResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: GoogleVertexAiGemini31FlashLitePreviewRequest, injector: Injector): Promise<GoogleVertexAiGemini31FlashLitePreviewResponse> => {
		...
		const response = await client.responses.create({
			model: "google-vertex-ai/gemini-3.1-flash-lite-preview",
			...(params as any),
			stream: false,
		} as any);
		...
		return {
			object: "response",
			model: (response as any).model ?? "google-vertex-ai/gemini-3.1-flash-lite-preview",
