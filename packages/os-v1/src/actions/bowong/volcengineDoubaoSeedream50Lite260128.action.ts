...
export const VolcengineDoubaoSeedream50Lite260128RequestSchema = Type.Object({
  ...
  "output_format": Type.Optional(Type.Union([Type.Literal("png"), Type.Literal("jpeg")])),
...
export type VolcengineDoubaoSeedream50Lite260128Request = Static<typeof VolcengineDoubaoSeedream50Lite260128RequestSchema>;

export const VolcengineDoubaoSeedream50Lite260128ResponseSchema = Type.Object({
...
export type VolcengineDoubaoSeedream50Lite260128Response = Static<typeof VolcengineDoubaoSeedream50Lite260128ResponseSchema>;

export const VOLCENGINE_DOUBAO_SEEDREAM50_LITE260128_TOKEN: Token<typeof VolcengineDoubaoSeedream50Lite260128RequestSchema, typeof VolcengineDoubaoSeedream50Lite260128ResponseSchema> = "bowong.model.volcengine.doubao.seedream.5.0.lite.260128.run";

export const volcengineDoubaoSeedream50Lite260128Action: Action<typeof VolcengineDoubaoSeedream50Lite260128RequestSchema, typeof VolcengineDoubaoSeedream50Lite260128ResponseSchema> = {
	type: VOLCENGINE_DOUBAO_SEEDREAM50_LITE260128_TOKEN,
	description: "Run Bowong model volcengine/doubao-seedream-5-0-lite-260128",
	request: VolcengineDoubaoSeedream50Lite260128RequestSchema,
	response: VolcengineDoubaoSeedream50Lite260128ResponseSchema,
	requiredPermissions: ["bowong:model:invoke"],
	dependencies: [],
	execute: async (params: VolcengineDoubaoSeedream50Lite260128Request, injector: Injector): Promise<VolcengineDoubaoSeedream50Lite260128Response> => {
		...
		const response = await client.images.generate({
			model: "volcengine/doubao-seedream-5-0-lite-260128",
			...(params as any),
		} as any);
